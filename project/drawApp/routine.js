...
let todo = {
	...
	handler: function (req, res) {
		render.html(res, {
			view: "./project/drawApp/views/todo.js",
		});
	}
};
let main = {
	...
	handler: function (req, res) {
		render.html(res, {
			view: "./project/drawApp/views/welcome.js",
		});
	}
};

//if define in other file, must exports handler and map 
let gallery = {
	map: {
		"index": LoadGallery,
		"new": loadCreateNewArt,
		"create": AddNewArtToDataBase,
		"show": router.nodef,
		"edit": editArt,
		"update": updateOne,
		"destroy": deleteOne,
...
function LoadGallery(req, res) {
	db.Gallery.find({}, function (err, gallery) {
		assert(err == null, err);
		render.html(res, {
			view: "/project/drawApp/views/gallery.js",
			data: gallery
		});
...
function loadCreateNewArt(req, res) {
	render.html(res, {
		view: "/project/drawApp/views/gallery-new.js",
	});
}
...
function editArt(req, res) {
	render.html(res, {
		view: "/project/drawApp/views/gallery-edit.js",
